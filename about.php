          ...
          <div class="col-lg-4 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services p-4 py-md-5">
              ...
              <div class="media-body">
                ...
                <p>We offer 24/7 customer suppoer on out hotline; +234(0)8164383860</p>
              </div>
            </div>    
          </div>
          <div class="col-lg-4 text-center d-flex align-self-stretch ftco-animate">
        	...
        	<div class="col-lg-5">
        		<div class="services-flow">
        			<div class="services-2 p-4 d-flex ftco-animate">
        				...
        				<div class="text">
	        				<h3>Free Shipping</h3>
	        				<p class="mb-0">Our shipping fee has been reduced to almost nothing. Buy today and allow us worry about the safe delivery of your order.</p>
        				</div>
        			</div>
        			<div class="services-2 p-4 d-flex ftco-animate">
        				<div class="icon">
        				...
        				<div class="text">
	        				...
	        				<p class="mb-0">Our payment systems are secured to a fault. Your details remain private to only you.</p>
	        			</div>
        			</div>
        			<div class="services-2 p-4 d-flex ftco-animate">
        				<div class="icon">
        				...
        				<div class="text">
	        				...
	        				<p class="mb-0">We offer 247 customer suppoer on out hotline; +234(0)8164383860</p>
	        			</div>
        			</div>
        		</div>
        	</div>
