  ...
  <body class="goto-here">
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Phone:</span> <a href="tel://1234567920">+234 (0)816 438 3680</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="mailto:ugahchymdy@gmail">ugahchymdy@gmail</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Social:</span> <a href="index.php">facebook.com/irish</a><br><a href="index.php">twitter.com/irish</a><br><a href="index.php">instagram.com/irish</a></p>
	          </div>
          </div>
        </div>
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" class="bg-white p-5 contact-form">
              ...
              <div class="form-group">
                <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Message" name="message" required></textarea>
              </div>
              <div class="form-group">
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$headers .= "From: contact@irish.com" . "\r\n";
		$dt = date("Y-m-d");
		$sql = "insert into _messages (name, email, message, date)values('$name', '$email', '$message', '$dt')";
		if($conn->query($sql)){
			mail("ugahchymdy@gmail.com", $subject, $message, $headers );
