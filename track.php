...
<html lang="en">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        ...
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="track.php" class="nav-link">Track</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Track</span></p>
            <h1 class="mb-0 bread">Track It</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  <script>
	if(!location.search){
		var trk = prompt('Please enter your ID', 'Order ID');
		if(trk){
			location.search = "q=" + trk;
		}else{
			history.back();
		}
	}
  ...
  <script>		
	...
	function placeMarker(map, trk) {
		$.post("ajx.php", {lat:trk}, function(data){
			...
			var infowindow = new google.maps.InfoWindow({
				content: 'Latitude: ' + curLoc.lat() + '<br>Longitude: ' + curLoc.lng()
			});
	...
	function myMap() {
		...
		var myCenter=new google.maps.LatLng(6.508742,3.380850);
		var mapOptions = {center: myCenter, zoom: 5};
		var map = new google.maps.Map(mapCanvas, mapOptions);
		var trk = "<?php echo($_GET['q']); ?>";
		placeMarker(map, trk);
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyArhMiq4SCMQe7CfgSZ0IieTHbGvrEGtlE&amp;callback=myMap">
  </script>
