...
<head>
  ...
  <title>I-rish-Admin | Inventory Tables</title>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
		  ...
		  <div class="box" style="box-shadow: 5px 5px 10px;">
            <div class="box-header">
              <h3 class="box-title">Stock Refills</h3>
			  <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i>
...
<?php
	function allProduct($conn){
		...
		while($row = $result->fetch_assoc()){
			echo "<tr><td>".$row['s/n']."</td><td>".$row['prodid']."</td><td>".$row['name']."</td><td>".$row['price']."</td><td>".$row['quantity']."</td></tr>";
		}
	}
	
	function stockRefills($conn){
		$sql = "select * from _refills";
		$result = $conn->query($sql);
		while($row = $result->fetch_assoc()){
			echo "<tr><td>".$row['date']."</td><td>".$row['product']."</td><td>".$row['quantity']."</td></tr>";
		}
	}
